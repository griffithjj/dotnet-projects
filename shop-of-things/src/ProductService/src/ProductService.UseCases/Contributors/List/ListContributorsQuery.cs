...
using ProductService.UseCases.Contributors.Create;
using FastEndpoints;

namespace ProductService.UseCases.Contributors.List;
...
public class ListContributorsQueryHandler2 : CommandHandler<ListContributorsQuery2, Result<IEnumerable<ContributorDTO>>>
{
    ...
    public override async Task<Result<IEnumerable<ContributorDTO>>> ExecuteAsync(ListContributorsQuery2 request,
